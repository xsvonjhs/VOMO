...
public class VideoPlayerHelper
{
    ...
    private string IDgetFromUser = null;
    public string FullURLhere = null;

    //int videoWidth = mVideoPlayerPtr.GetVideoWidth();
    ...
    /// </summary>
    public void SetFilename(string filename, bool checkspon, string sponname, int frameDenum)
    {
#if UNITY_ANDROID
        ...
        {
            mFilename = filename;
            IDgetFromUser = (PlayerPrefs.GetString("userID"));
            FullURLhere = "http://www.builtbee.com/VOMO/uploads/vid" +IDgetFromUser + "_Frame" + frameDenum  +".mp4";
            mFilename = FullURLhere;
            PlayerPrefs.SetString("URLIDtgt", FullURLhere);
        ...
        {
            mFilename = sponname;
            FullURLhere = "http://www.builtbee.com/VOMO/sponsor/vid_" + sponname + ".mp4";
            mFilename = FullURLhere;
            PlayerPrefs.SetString("URLIDtgt", FullURLhere);
            videoPlayerSetActivity();
        }
        ...
        if (videoPlayerIsFileInAssetsFolder(filename) || filename.Contains("://"))
        {
            ...
            mFullScreenFilename = FullURLhere;
        }
        else
        {
    ...
    /// </summary>
    public bool Load(string filename, MediaType requestedType, bool playOnTextureImmediately, float seekPosition, bool gotspon, string gotsponname, int theframecode )
    {
        SetFilename(filename, gotspon , gotsponname, theframecode );
    ...
    {
        //int x = videoPlayerGetVideoWidth()/3;
        //return x;
    ...
    {
        //int y = videoPlayerGetVideoHeight() / 2;
        //return y;
